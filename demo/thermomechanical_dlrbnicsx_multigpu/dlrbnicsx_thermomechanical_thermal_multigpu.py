...
thermal_gpu_group0_procs = world_comm.group.Incl([0])# world_comm.group.Incl([0, 1, 2, 3])
...
if thermal_gpu_group0_comm != MPI.COMM_NULL:
    ...
    thermal_training_set_indices_gpu = np.arange(thermal_gpu_group0_comm.rank,
                                         ...
                                         thermal_gpu_group0_comm.size)
    thermal_validation_set_indices_gpu = np.arange(thermal_gpu_group0_comm.rank,
    ...
    for thermal_epochs in range(thermal_start_epoch, thermal_max_epochs):
        ...
        thermal_current_validation_loss = validate_nn(thermal_reduced_problem,
                                              ...
                                              thermal_model, cuda_rank_list[thermal_gpu_group0_comm.rank],
                                              thermal_loss_fn)
...
mechanical_gpu_group0_procs = world_comm.group.Incl([1]) # world_comm.group.Incl([4, 5, 6, 7])
