...
zero.x.set(0.0)
dofs_5 = dolfinx.fem.locate_dofs_geometrical(Q, lambda x: np.isclose(x.T, [1, 1, 0]).all(axis=1))
bc_p = dolfinx.fem.dirichletbc(zero, dofs_5)
...
bcs = [bc_left, bc_top, bc_right, bc_bottom, bc_p]
