...
refinement_field = gmsh.model.mesh.field.add("Threshold")
gmsh.model.mesh.field.setNumber(refinement_field, "IField", distance_field)
gmsh.model.mesh.field.setNumber(refinement_field, "LcMin", lc/4)
gmsh.model.mesh.field.setNumber(refinement_field, "LcMax", lc)
gmsh.model.mesh.field.setNumber(refinement_field, "DistMin", 0.0)
gmsh.model.mesh.field.setNumber(refinement_field, "DistMax", 0.3)
