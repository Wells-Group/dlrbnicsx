...
point_a = gmsh.model.occ.addPoint(min_r, min_z, 0., 9.e-8)
point_b = gmsh.model.occ.addPoint(max_r, min_z, 0., 9.e-8)
point_c = gmsh.model.occ.addPoint(max_r, 0, 0., 6.e-8)
point_d = gmsh.model.occ.addPoint(max_r, max_z, 0., 9.e-8)
point_e = gmsh.model.occ.addPoint(min_r, max_z, 0., 9.e-8)
point_f = gmsh.model.occ.addPoint(min_r, 0, 0., 6.e-8)
